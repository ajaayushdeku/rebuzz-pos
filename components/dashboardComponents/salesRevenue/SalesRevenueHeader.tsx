...
import { resolveRange } from "./salesRevenueRange";

/**
 * Global date-range filter for the Sales & Revenue page.
 * The selected range is stored in the URL (startDate/endDate) so it acts as
 * the single source of truth shared by the components that depend on it.
 */
